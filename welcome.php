      ...
      <div id="inscription">
        <details><summary>Comment jouer ?</summary>
          <p>
            ...
            <b>Durée de partie :</b> environ 3 minutes / joueurs<br/>
          ...
          <p>
            ...
            - À droite du mot à représenter se trouve une horloge qui peut être déclenchée si un autre joueur a fini avant vous. Il vous sera donc indiqué le temps restant avant que votre dessin ne soit automatiquement envoyé.<br/>
            <u>Conseils de pro :</u><br/>
            - Plus vous utilisez de peinture, plus vos 'points de couleurs' (affichés en bas) augmentent. Essayez de les garder assez bas pour présenter votre oeuvre avant vos 'coéquipiers' disposant du même mot.<br/>
            - Sur la gauche se trouve le tableau de score, avec la composition des équipes entre crochets. Regardez qui est dans votre équipe et affinez votre stratégie des 'points de couleurs' en fonction de vos 'coéquipiers'.
          </p>
          <h2>La phase de suppositions</h2>
          <p>
            Durant cette phase vous devrez deviner ce que les pixel arts des autres équipes représentent. Si vous pensez à quelque chose, <span class="highlight">écrivez le mot dans le chat</span> (à droite). Vous avez le droit à autant de propositions que souhaité durant le temps imparti (affiché en haut). Si vous trouvez le mot, un message dans le tchat vous en tiendra informé et vous marquerez vos points à la fin du temps.<br/>
            ...
            - Quand tous les dessins d'une équipe ont été dévoilés, un indice doit être écrit dans le tchat par un membre de cette équipe (le jeu vous dira quand).<br/>
            - Si l'indice est annoncé, les dessinateurs ne marquent pas de point.
          </p>
          <h2>Fin de partie</h2>
          <p>
            Un fois le nombre de rondes dépassé (en haut à gauche), la partie prend fin et le score est établi !
          </p>
          <h2>Jouer !</h2>
          <p>
